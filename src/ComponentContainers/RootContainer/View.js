...
class RootContainer extends React.Component
{
    ...
    {
        return (
            pageId === REQUIRE_LOGIN_PAGE_ID.HOSPITAL_INSURANCE_LIST ||
            pageId === REQUIRE_LOGIN_PAGE_ID.HOSPITAL_INSURANCE_PUBLICATION ||
            pageId === REQUIRE_LOGIN_PAGE_ID.HOSPITAL_INSURANCE_DETAIL
        );
    };
    ...
    {
        return (
            pageId === REQUIRE_LOGIN_PAGE_ID.HOSPITAL_INSURANCE_PURCHASING_PROCESS ||
            pageId === REQUIRE_LOGIN_PAGE_ID.HOSPITAL_INSURANCE_PURCHASING_DETAIL
        );
    };
    ...
    render()
    {
        ...
        return (
            <Root hasLoggedIn={hasLoggedIn}
                  insuranceUrl={PAGE_ID_TO_ROUTE[REQUIRE_LOGIN_PAGE_ID.HOSPITAL_INSURANCE_LIST]}
                  directPaymentUrl={PAGE_ID_TO_ROUTE[REQUIRE_LOGIN_PAGE_ID.HOSPITAL_DIRECT_PAYMENT_PROCESS]}
                  insurancePurchasingUrl={PAGE_ID_TO_ROUTE[REQUIRE_LOGIN_PAGE_ID.HOSPITAL_INSURANCE_PURCHASING_PROCESS]}
